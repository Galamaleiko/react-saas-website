                ...
                <div className='container'>
                    <div className='max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
                        ...
                        <div className='pricing-bg'>
                            ...
                            <img src='/images/bg-outlines-fill.png' width={960} height={380} alt='fill' className='absolute inset-0 opacity-5 mix-blend-soft-light' />
                        </div>
                    </div>
                    ...
                    <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6'>
                        {plans.map(({ id, title, priceMonthly, priceYearly, caption, features, icon, logo }, index) => (
                            <div
                                key={id}
                                className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.3%+2px)]'>
                                {index === 1 && (
                                ...
                                <div className={clsx('relative flex flex-col items-center',
                                    ...
                                    <div className='z-2 relative items-center flex justify-center'>
